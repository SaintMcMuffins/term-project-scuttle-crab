...
| User organizes hand |The player's preferred sorting method (suit or rank). |The player has at least one card in their hand. |The player's hand is sorted by the selected method. | |
...
| User knocks | None |The player has a hand that can form melds that total 10 or fewer points (after adding the value of deadwood cards, which are unmelded cards), and the opponent has not yet knocked during the round.|The round ends, and the player's hand is compared to the opponent's hand to determine the winner of the round. | |
